...
const displayDataInFerheneit = (result) => {
	...
	min_temp.innerHTML = `Temp_min:${toFreneheit(result.main.temp_min)} ℉ | `;
	max_temp.innerHTML = `Temp_max:${toFreneheit(result.main.temp_max)} ℉ | `;
	humidity.innerHTML = `Humidity:${result.main.humidity}`;
...
export { displayData, displayError, changeToCelcius, changeToFerheneit };
